...
public class NegativaBuroA implements RequestStreamHandler{
    @Override
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException
    {
        ...
        responseBody.addProperty("message", "Cliente Negativado");
        responseBody.addProperty("body", inputStream.read());

        // um header aleatório na resposta para API Gateway
        headerJson.addProperty("x-custom-header", "Negativaçao Buro A");
